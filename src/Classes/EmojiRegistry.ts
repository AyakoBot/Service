...
const buildEmoteSet = (resolve: (name: EmoteName) => APIPartialEmoji) => ({
 ...
 upvote: resolve(EmoteName.Upvote),
 downvote: resolve(EmoteName.Downvote),
 ...
 separator: resolve(EmoteName.Separator),
 reactionRole: resolve(EmoteName.ReactionRole),
 selfRole: resolve(EmoteName.SelfRole),
 stickyRole: resolve(EmoteName.StickyRole),
 stickyPerm: resolve(EmoteName.StickyPerm),
 boosterRole: resolve(EmoteName.BoosterRole),
 ...
 trophy: resolve(EmoteName.Trophy),
 podium: resolve(EmoteName.Podium),
 xp: resolve(EmoteName.Xp),
 curve: resolve(EmoteName.Curve),
 boost: resolve(EmoteName.Boost),
 globe: resolve(EmoteName.Globe),
 cpu: resolve(EmoteName.Cpu),
 shield: resolve(EmoteName.Shield),
 spam: resolve(EmoteName.Spam),
 raid: resolve(EmoteName.Raid),
 virus: resolve(EmoteName.Virus),
 vote: resolve(EmoteName.Vote),
 ...
 kick: resolve(EmoteName.Kick),
 softban: resolve(EmoteName.Softban),
 deafen: resolve(EmoteName.Deafen),
 muted: resolve(EmoteName.Muted),
 ...
 timedout: resolve(EmoteName.Timedout),
