 ...
 */
export default async <T extends RMessage<boolean>>(
 msg: T,
 ...
 const messagePayload = new RMessagePayload(msg, {
  ...payload,
  reply: {
...
export const cooldownHandler = async (
 ...
 sentMessage: RMessage | Discord.InteractionResponse,
 commandName: string,
) => {
 if (!msg.guild) return;
 ...
 Jobs.scheduleJob(
  ...
  async () => {
   reactions.forEach((react) => {
    request.channels.deleteOwnReaction(m as RMessage, react);
