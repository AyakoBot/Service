...
import type { RInteractionMessage as _RInteractionMessage } from '@ayako/gateway/src/BaseClient/Bot/CacheClasses/interactionMessage.js';
...
declare global {
 ...
 type RInteractionMessage = _RInteractionMessage;
}
