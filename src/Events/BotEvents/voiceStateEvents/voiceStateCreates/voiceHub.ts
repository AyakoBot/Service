...
export const getPayload = async (
 language: Language,
 owner: RUser,
 channel: Discord.VoiceChannel | RChannel,
) => {
...
export const getManagers = (channel: Discord.VoiceChannel | RChannel) =>
 channel.permissionOverwrites.cache.filter(
  (p) => p.type === Discord.OverwriteType.Member && p.allow.has(managerPermissions),
 );

export const getMembers = (channel: Discord.VoiceChannel | RChannel) =>
 channel.permissionOverwrites.cache.filter(
