...
const dmCommand = async (msg: RMessage) => {
...
const guildCommand = async (msg: RMessage) => {
...
export const getPrefix = async (msg: RMessage) => {
...
export const checkCommandPermissions = async (
 ...
 const rolePermissions = commandPerms.filter(
  (p) => p.type === RCommandPermissionType.Role,
 );
